...
%Calculating amount of Waste in that location using ZipCode and adding
%annotations
if zoomlevel ==13
...
dindex=dindex+1;
  ...
  dim_eclipse_77062 = [.2 .69 .20 .15]; %Ploting Eclipse around the markers(ZIP 77062) in the location
  dim_eclipse_77058 = [.5 .38 .22 .17];%Ploting Eclipse around the markers(ZIP 77058) in the location
  
dim_77058 = [.6 .3 .18 .1];
 dim2_77062= [.2 .68 .18 .1];
%annotation('ellipse',dim);
str ="Total Waste :"+num2str(totalWaste_77058)+"lbs"; %Annotation around the Markers zip 77058
annotation('textbox',dim_77058,'String',str,'FitBoxToText','on');
str2 ="Total Waste :"+num2str(totalWaste_77062) +"lbs";
annotation('textbox',dim2_77062,'String',str2,'FitBoxToText','on'); %Annotation around the Markers zip 77062
annotation('ellipse',dim_eclipse_77062);
annotation('ellipse',dim_eclipse_77058);
end
if zoomlevel > 19 
    zoomlevel = 19;
end
...
%avgZoomLevel = (convertedZoomVal + counter)/2;
%fprintf("Average Zoom Level %d ",avgZoomLevel);
%if avgZoomLevel >= 26
%    GarbageAnalysis();
%end
